...
{-|
  The main functions of 2ltt. The actual program entry point is in Main.hs, we only
  have this module to be able to export the `main` and `main'` functions.
-}

module MainInteraction (main, main') where
