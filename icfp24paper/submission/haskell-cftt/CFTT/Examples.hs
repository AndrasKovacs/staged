...
-- This could be a filterM application, but I inline the filterM definition here
-- because of TH module restrictions.
...
-- Medium-sized zip of two loops, again inlined because of module stage restrictions.
exS7 :: [(Int, Int)]
exS7 = $$(toList $ P.zip
