...
%% \begin{itemize}
%%   \item Start with monadic code in a non-staged language.
%%   \item Try to infer stages, inventing quotes, splices, $\mup$-s and $\mdown$-s,
%%         thereby translating definitions to 2LTT.
%%   \item Stage the obtained definitions.
%% \end{itemize}
%% In this approach, much complexity is factored out to staging
