...
\vf\,(\vg\,\vx)$, to get better inlining behavior \cite{ghcbase}. Tellingly, it
is common practice in high-performance Haskell programming to visually review
GHC's optimized code output.
