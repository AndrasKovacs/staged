...
%% This is fairly similar to the well-known monomorphization models in the C++ and
...
The multi-stage calculus in \cite{multi-stage-calculus}
...
modality (see e.g.\ \cite{DBLP:journals/jacm/DaviesP01}),
