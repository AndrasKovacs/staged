...
\begin{theorem}[Soundness of staging] The open staging algorithm from Definition \ref{TODO} is sound.
\end{theorem}
\begin{proof}
\mbox{}
\begin{itemize}
...
\begin{corollary}[Conservativity of 2LTT]
...
%% \begin{alignat*}{3}
%%   & \hspace{1em} \emb{\Stage\,A} \hspace{2em}&& \\
%%   & = \emb{|\ev\,A|\,\Gamma^P}   \hspace{2em}&& \text{by the definition of $\Stage$} \\
%%   & = A                          \hspace{2em}&& \text{by $|A\rel|\,{\Gamma^P}\rel : \emb{|\ev\,A|\,\Gamma^P} = A[\id]$}
%% \end{alignat*}
